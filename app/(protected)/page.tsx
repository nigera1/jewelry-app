...
import { useAdminState } from '@/app/(protected)/admin/hooks/useAdminState'
import { KANBAN_COLUMNS } from '@/app/(protected)/admin/constants'
import { KanbanColumn } from '@/app/(protected)/admin/components/KanbanColumn'
import { ActivityLog } from '@/app/(protected)/admin/components/ActivityLog'
import { ArchiveTable } from '@/app/(protected)/admin/components/ArchiveTable'
import { OrderModal } from '@/app/(protected)/admin/components/OrderModal'
        ...
        <div className="flex bg-black p-1 rounded-2xl w-full sm:w-fit">
          {[
            ...
            <button
              ...
              className={`flex items-center justify-center gap-2 flex-1 sm:flex-none sm:px-8 px-4 py-3 rounded-xl font-black text-xs sm:text-sm uppercase tracking-wide transition-all ${activeTab === id
